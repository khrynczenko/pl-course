...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero funny-number-stream) 2) (list (cons 0 1) (cons 0 2)) "stream-add-zero test 3")
   ...
   (check-equal? (vector-assoc 7 (vector (cons 2 1) (cons 3 1) (cons 4 1) (cons 5 1))) #f "vector-assoc test")
